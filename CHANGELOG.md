...
- add canonical_without_checksum helper with optional none_on_error
- add remove_checksum for canonical open xPD UUIDs
- add Open xPD UUID regex patterns
...
- relax supported Python version upper bound to \<4
